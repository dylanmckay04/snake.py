...
# Display text
def display_message(text: str, size: int | float, color: pygame.Color | str | int | Tuple[int, int, int, int], y_offset: int | float = 0, center: bool = True, position: Tuple[int, int] = (0,0)) -> None:
